...
## Project Structure
    ...
    ├── testapiautostorybo_104250  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_104250`
...
2. Clone this repo and `cd testapiautostorybo_104250`
